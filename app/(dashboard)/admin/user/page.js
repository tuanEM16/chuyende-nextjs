...
export default function UserPage() {
    const { user, logout, isLoading } = useAuth(); // Lấy thông tin từ AuthContext
    ...
    if (isLoading || !user) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <p className="text-indigo-600 font-medium animate-pulse">Đang tải hồ sơ...</p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <h1 className="text-4xl font-extrabold text-slate-900 mb-8 border-b pb-3">Hồ sơ Cá nhân</h1>
