...
export default function AddProductPage() {
    ...
    // Form chính (Đã bỏ price_root và stock)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            data.append('qty', 0); // Mặc định tồn kho bằng 0
            ...
            if(confirm('Thêm sản phẩm thành công! Bạn có muốn nhập kho ngay không?')) {
                router.push('/admin/productstore'); // Chuyển sang trang nhập kho
            } else {
